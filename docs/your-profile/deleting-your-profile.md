...
6. In the confirmation modal, review the message:
   *This will permanently delete your account and all associated data. This cannot be undone.*
   Then click **Yes, delete my account**.

Shortcut: [https://app.daily.dev/settings/security](https://app.daily.dev/settings/security)

If you have an active Apple subscription, the delete button is disabled. Cancel your subscription in Apple first, then return to this page and delete your account.
