...
- **Full control**: Set your budget in [cores](/docs/monetization/cores) and track new members in
  real-time
...
:::tip Combine both strategies: Use Squad Boost for member acquisition and Post Boost to showcase
your best content. Members can also support your Squad by giving
[Awards](/docs/monetization/awards), which transfer cores directly to admins and moderators for
future boosts. :::

**Ready to boost?** Visit your Squad page and click "Boost" or learn more in our
[Boost documentation](/docs/monetization/boost).
...
[Post and Squad Analytics](/docs/your-profile/post-and-squad-analytics).
