...
:::info Keep in mind that you can only select either upvote or downvote for a post—not both. This
...
express appreciation for the work of others. Here’s why upvoting is highly encouraged:
...
Downvotes indicate that you didn’t find a post helpful or interesting. Here’s why downvoting is
important:

1. It provides feedback that enhances our recommendation engine, improving your experience on
   daily.dev.
2. Although downvote counts are private and not visible to others, each downvote impacts the post’s
   ranking in the feed.
...
contribute to the community’s feedback, showing appreciation for quality content.

## How to Downvote

To downvote a post, you can do so either on the post page itself or in the feed. Click on the more
options menu for each card, then select "downvote." Note that once you downvote a post, you won’t be
able to upvote it.
...
Just click on the bottom on the left, with the 🔗 icon, and you will have the link in your
clipboard!
